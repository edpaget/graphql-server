...
2. **Read the roadmap**: `rdm roadmap show <slug> --project graphql-server` to get the overview and phase list.
...
4. **Read each phase**: `rdm phase show <stem> --roadmap <slug> --project graphql-server --format json` for each phase. Collect titles, bodies, and commit SHAs.
