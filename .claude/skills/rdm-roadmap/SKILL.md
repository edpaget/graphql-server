...
3. **Create the roadmap**: `rdm roadmap create <slug> --title "Title" --body "Summary." --no-edit --project graphql-server`
4. **Create each phase** with context, steps, and acceptance criteria in the body:
   ...
   EOF
   ```
5. **Verify** the roadmap looks correct: `rdm roadmap show <slug> --project graphql-server`
